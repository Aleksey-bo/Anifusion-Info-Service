...
async def create_movie(data: MovieCreateUpdate, movie_service: Annotated[MovieService, Depends(movie_service)]):
...
async def update_movie(movie_id: int, data: MovieCreateUpdate, movie_service: Annotated[MovieService, Depends(movie_service)]):
